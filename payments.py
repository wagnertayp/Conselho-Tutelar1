        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if mapped_status == 'completed':
                    ...
                    if abs(payment_amount_reais - 73.40) < 0.01:
                        current_app.logger.info(f"R$ 73.40 payment confirmed - triggering automatic redirection to /aviso")
...
def create_payment_api(secret_key: Optional[str] = None) -> For4PaymentsAPI:
    ...
    if secret_key is None:
        secret_key = os.environ.get("FOR4PAYMENTS_SECRET_KEY") or "40737fc5-a56a-41c6-82bf-f59066888409"
